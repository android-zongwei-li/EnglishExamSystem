...
/**
 * 这个类持有一些验证手机号码是否正确的方法
 */
public class PhoneNumberUtils {

    /**
     * 提供给外部使用的，判断一串字符是否是手机号
     * @param phoneNums
     * @return
     */
    ...
    private static boolean isMobileNO(String mobileNums) {
         ...
         * 电信：133、153、180、、173、189、（1349卫通）
         * 总结起来就是第一位必定为1，第二位必定为3或5或8，其他位置的可以为0-9
         */
        String telRegex = "[1][35867]\\d{9}";// "[1]"代表第1位为数字1，"[358]"代表第二位可以为3、5、8中的一个，"\\d{9}"代表后面是可以是0～9的数字，有9位。
